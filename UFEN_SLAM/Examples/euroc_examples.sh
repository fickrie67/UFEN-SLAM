...
./Examples/Stereo/stereo_euroc ../Vocabulary/ORBvoc.txt Examples/Stereo/EuRoC.yaml  /home/student.unimelb.edu.au/jinghey/ORB_SALM3/V203 Examples/Stereo/EuRoC_TimeStamps/V203.txt dataset-V203_stereo

./Examples/Stereo/stereo_euroc ./Vocabulary/ORBvoc.txt Examples/Stereo/EuRoC.yaml  ./V203 Examples/Stereo/EuRoC_TimeStamps/V203.txt dataset-V203_stereo

rosrun ORB_SLAM3 Stereo_Inertial Vocabulary/ORBvoc.txt Examples/Stereo-Inertial/EuRoC.yaml true

rosbag play --pause bus_out_loop_w_cam_info.bag /cam0/image_raw:=/slave1/image_raw/compressed /cam1/image_raw:=/slave2/image_raw/compressed /imu0:=/imu/filter
