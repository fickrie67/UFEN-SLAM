...
public:
    ...
    int SearchByProjection(Frame &F, const std::vector<MapPoint*> &vpMapPoints, const float th=5, const bool bFarPoints = false, const float thFarPoints = 50.0f);
    ...
    int SearchByNN(Frame &F, const std::vector<MapPoint*> &vpMapPoints, const float th=5, const bool bFarPoints = true, const float thFarPoints = 50.0f);
    
    int SearchByNN(KeyFrame *pKF, Frame &F, std::vector<MapPoint*> &vpMapPointMatches);
    int SearchByNN(Frame &F, const vector<MapPoint*> &vpMapPoints, const cv::Mat &K);
    ...
    int Fuse(KeyFrame* pKF, const vector<MapPoint *> &vpMapPoints, float th=3.0, const bool bRight = false); //try 3.0
